(function(){
	...
	// Evento para el boton de minusculas que activara o desactivara si queremos minusculas en la contraseña.
	app.elements.namedItem('btn-minusculas').addEventListener('click', function(){
		// Ejecutamos la funcion que alternara el icono y el fondo del boton.
		btnToggle(this);
